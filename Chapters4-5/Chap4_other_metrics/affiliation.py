import Chap4_other_metrics.affiliation_utils as affiliation_utils
import Chap4_other_metrics.utils as utils
...
def affiliation_recall_score(y_true, y_pred, pos_label):
    event_labels = utils.get_contiguous_region(y_true)[pos_label]
    event_pred = utils.get_contiguous_region(y_pred)[pos_label]
    res = pr_from_events(event_pred, event_labels, (0, y_true.size))
    return res["recall"]